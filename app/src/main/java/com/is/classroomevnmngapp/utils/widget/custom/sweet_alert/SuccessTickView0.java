...
public class SuccessTickView0 extends View {
    ...
    public SuccessTickView0(Context context) {
        super(context);
        init();
    }

    public SuccessTickView0(Context context, AttributeSet attrs){
        super(context,attrs);
        init();
    }
    ...
    private void init () {
        mPaint = new Paint();
        mPaint.setColor(getResources().getColor(R.color.is_success_stroke_color));
