package com.is.classroomevnmngapp.utils.widget.custom.sweet_alert.progress;
...
public class ProgressWheel0 extends View {
    private static final String TAG = ProgressWheel0.class.getSimpleName();
    ...
    public ProgressWheel0(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * The constructor for the ProgressWheel
     */
    public ProgressWheel0(Context context) {
        super(context);
        setAnimationEnabled();
    }
